<script lang="ts">
    ...
    function fakeWordGuessInput(wg: WordGuess) {
        ...
        wordGuessInput = { word: wg.word, idx: undefined };
    }
            ...
            if (topWords !== null) {
                if (allTopWords)
                    for (let tw of topWords) {
                        // here we want to bypass NewGuessedWord component and inject
                        // top words directly into words table
                        onNewWordGuess(tw, false);
                    }
...
<div class="page-text-block">
    ...
    {#if wordGuessInput != null}
        <NewGuessedWord
            ...
            {alreadyExistingWordGuess}
            on:newWordGuess={(e) => onNewWordGuess(e.detail.wg, true)}
        />
    {/if}
